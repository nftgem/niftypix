...
(function () {
  ...
  ns.app = {
    init: function () {
      ...
      var descriptor = new pskl.model.piskel.Descriptor("New NiftyPix", "");
      ...
      this.nftStorageService = new pskl.service.storage.NFTStorageService(
        this.piskelController
      );
      this.nftStorageService.init();
